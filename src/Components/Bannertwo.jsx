...
import TravelImg from "../assets/BannertwoPhoto.png";
            ...
            <div className=" px-[20px]">
              ...
              >
                ...
                <div className="space-y-8 ">
                  ...
                  <div className="flex items-center gap-4">
                    <MdOutlineLocalHotel className="text-4xl h-12 w-12 shadow-sm p-3 rounded-full bg-linear-to-r from-bg-blue-100 to-bg-blue-500 text-white " />
                    <p>Hotel</p>
                  </div>
                </div>
                <div className="space-y-8">
                  <div className="flex items-center gap-4">
                    <IoIosWifi className="text-4xl h-12 w-12 shadow-sm p-3 rounded-full bg-linear-to-r from-bg-blue-100 to-bg-blue-500 text-white " />
                    <p>Wi-Fi</p>
                  </div>
                  <div className="flex items-center gap-4">
                    <IoFastFoodSharp className="text-4xl h-12 w-12 shadow-sm p-3 rounded-full bg-linear-to-r from-bg-blue-100 to-bg-blue-500 text-white " />
                    <p>Foods</p>
                  </div>
                </div>
